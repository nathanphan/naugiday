      ...
      home: Scaffold(
        body: Column(
          children: [
            ...
            FilledButton(
              key: const ValueKey('pick_button'),
              onPressed: () =>
...
void main() {
  ...
  testWidgets('gallery flow adds image', (tester) async {
    const filePath = '/tmp/scan_gallery_it.jpg';
    ...
    final container = ProviderScope.containerOf(
      tester.element(find.byKey(const ValueKey('count'))),
    );
    await container.read(scanControllerProvider.notifier).pickFromGallery();
